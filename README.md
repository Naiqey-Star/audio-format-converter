...
从 [**Releases 页面**](../../releases/latest) 下载，双击安装包即可。

| 文件 | 大小 | 说明 |
| --- | --- | --- |
| `ZhuanZhuan_Setup_2.0.0.exe` | 85 MB | **安装包（推荐）**，双击即装，**不需要管理员权限** |
| `ZhuanZhuan_2.0.0_portable.zip` | 83 MB | **免安装绿色版**，解压即用，适合放 U 盘 |
| `RELEASE_2.0.0.sha256` | 189 B | 上面两个文件的 SHA256 校验值 |

> 两个包内都已包含 Python 运行时和 **ffmpeg**，目标机器不需要额外安装任何东西。
> （`ZhuanZhuan` 是「转转」的拼音，用于文件名以保证各系统下载兼容。）
...
1. 双击 `ZhuanZhuan_Setup_2.0.0.exe` 完成安装
